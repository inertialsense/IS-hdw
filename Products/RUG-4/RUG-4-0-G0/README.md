...
![RUG-4-IMX-5](Images/rug-4.0-g0.png)

<center/>

The **RUG-4** adds a rugged aluminum enclosure and RS232, RS485, and CAN bus to the **IMX-6**.  Addition of an external GNSS receiver enables the onboard Inertial Navigation System (INS) sensor fusion for roll, pitch, heading, velocity, and position.  
