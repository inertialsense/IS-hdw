...
![IG-2.0](Images/IG-2.png)

The InertialSense IG-2.0 module combines the IMX-5 and GPX-1 dual multi-band GNSS receiver in a compact surface mount modular form factor. 
